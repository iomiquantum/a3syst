...
const CONFIG: Record<string, { label: string; bg: string; text: string }> = {
  ...
  seguimiento_s5: { label: "S5", bg: "bg-amber-100 dark:bg-amber-500/20", text: "text-amber-700 dark:text-amber-300" },
  seguimiento_s6: { label: "S6", bg: "bg-amber-100 dark:bg-amber-500/20", text: "text-amber-700 dark:text-amber-300" },
